        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 font-weight-bold text-danger">
              <i class="fa fa-clock"></i> Ujian Selesai
            </h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="card card-danger card-outline text-dark">
              <div class="card-body text-center">
                <h3>Ujian Telah Tersimpan</h3>   
                <h5>Nilai</h5>
                <h1><?=$score?></h1>
                <p>Klik tombol di bawah ini untuk kembali ke halaman utama</p>           
              </div>
              <div class="card-footer text-center">
                <a href="<?=base_url('siswa/');?>" type="button" class="btn btn-danger">Kembali</a>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
